...
#
# 1) beer labels in numeric format, there might be need to get some verbal labels for them later

#
# 1. constants
#

DATASET_URL_1 = "https://www.kaggle.com/dsv/1885260"
DATASET_FILE_1 = "archive.zip"
DATASET_SUM_1 = "ba7af65e96c7640300b1260c51eeea39"
...
def parse_dataset(
    ...
    class_list = os.listdir(dataset_root_path + "original_files/" + "beer_labels")
