...
#
# 1) the archive contains a reduced dataset as well as some extra images
...
DATASET_URL_1 = "https://www.kaggle.com/datasets/emirhanai/planets-and-moons-dataset-ai-in-space/download?datasetVersionNumber=11"
DATASET_FILE_1 = "archive.zip"  # note: different name compare to google doc
DATASET_SUM_1 = "ffcf41dcb19ded004446fe4465e529cc"
...
def parse_dataset(
    ...
    class_list = os.listdir(
        dataset_root_path + "original_files/" + "Planets_Moons_Data/Planets and Moons"
    )
    ...
    for image_path in image_path_list:
        ...
        # check non-dataset image
        if len(image_path.split("/")) == 2:
            problem_value = 2
        elif "Test" in image_path.split("/")[1]:
            problem_value = 5
        elif "Planets_Moons_Reduced_Data" == image_path.split("/")[-4]:
            problem_value = 5
