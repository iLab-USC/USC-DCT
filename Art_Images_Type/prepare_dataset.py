...
DATASET_URL_1 = "https://www.kaggle.com/datasets/thedownhill/art-images-drawings-painting-sculpture-engraving/download?datasetVersionNumber=2"
DATASET_FILE_1 = "archive.zip"
DATASET_SUM_1 = "80db4304c7ca152f68c4eb040b91fe2f"
...
def parse_dataset(
    ...
    class_list = os.listdir(
        dataset_root_path + "original_files/" + "dataset/dataset_updated/training_set"
    )
    ...
    for image_path in image_path_list:
        ...
        if "musemart" in image_path:
            if ("drawings" in image_path) or ("painting" in image_path):
                problem_value = 3
            else:
                if "training_set" in image_path:
                    if ("iconography" in image_path) or ("engraving" in image_path):
                        problem_value = 3
        ...
        if problem_value != 0:
            ...
            if "training" in image_path.split("/")[-3]:
                set_value = 0
            elif "validation" in image_path.split("/")[-3]:
                set_value = 1
