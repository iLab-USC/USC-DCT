...
#
# 1) asl_alphabet_test folder seems to have duplicate images per hash computation,
#    but left as problem=0 to be removed later.
...
DATASET_URL_1 = "https://www.kaggle.com/datasets/grassknoted/asl-alphabet"
DATASET_FILE_1 = "archive.zip"
DATASET_SUM_1 = "9a0a397aef38a4a36209c5e1c4d1d837"
...
def parse_dataset(
    ...
    class_list = os.listdir(
        dataset_root_path + "original_files/" + "asl_alphabet_train/asl_alphabet_train"
    )
    ...
    for image_path in image_path_list:
        ...
        if "asl_alphabet_test" in image_path:
            set_value = 2
