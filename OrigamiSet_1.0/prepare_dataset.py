...
#
# 1) contains a difficulty-rating task and a classification task
# 2) the classification task uses the same images
...
DATASET_URL_1 = (
    "https://github.com/multimedia-berkeley/OriSet/archive/refs/heads/master.zip"
)
DATASET_FILE_1 = "master.zip"
DATASET_SUM_1 = "e345dcc4a3fb2e903389535fc3a437b0"
...
def parse_dataset(
    ...
    class_list = os.listdir(
        dataset_root_path + "original_files/OriSet-master/difficulties/giladori/"
    )
    ...
    for image_path in image_path_list:
        ...
        # other dataset image
        if image_path.split("/")[2] == "origami_classification_data":
            problem_value = 6
