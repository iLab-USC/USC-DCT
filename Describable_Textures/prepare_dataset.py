...
#
# 1) since there were no given class_ids, the id is taken starting from 0 and using the
#    sorted class_names list
# 2) since the sets contain multiple shuffles, assume all images were in the training set
#
...
DATASET_URL_1 = "https://www.robots.ox.ac.uk/~vgg/data/dtd/download/dtd-r1.0.1.tar.gz"
DATASET_FILE_1 = "dtd-r1.0.1.tar.gz"
DATASET_SUM_1 = "fff73e5086ae6bdbea199a49dfb8a4c1"
...
def parse_dataset(
    ...
    # since there is no separate list of class_names (other than directories)
    # use an ordered list
