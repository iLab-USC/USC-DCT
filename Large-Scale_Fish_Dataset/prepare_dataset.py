...
#
# 1) contains masks for images

#
# 1. constants
#

DATASET_URL_1 = "https://www.kaggle.com/datasets/crowww/a-large-scale-fish-dataset/download?datasetVersionNumber=2"
DATASET_FILE_1 = "archive.zip"
DATASET_SUM_1 = "b9da047a59238d2f2eb7d8c2617ef4ed"
...
def parse_dataset(
    ...
    class_list = os.listdir(dataset_root_path + "original_files/" + "NA_Fish_Dataset")
    ...
    for image_path in image_path_list:
        # problem_value: related to image
        # set_value: related to train/val/test
        ...
        # without problem
            ...
            if class_from_path == "Hourse Mackerel":
                class_from_path = "Horse Mackerel"
            elif class_from_path == "Gilt-Head Bream":
                class_from_path = "Gilt Head Bream"
