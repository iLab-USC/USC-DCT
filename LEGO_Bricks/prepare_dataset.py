...
# It contains two version datasets. According to website, only use version 2 data (40000 images with 50 classes)
# Set version 1 image to problem_value=2

#
# 1. constants
#

DATASET_URL_1 = "https://www.kaggle.com/datasets/joosthazelzet/lego-brick-images/download?datasetVersionNumber=4"
DATASET_FILE_1 = "archive.zip"
DATASET_SUM_1 = "a20d1f6b96368ade0cb13f8aeb02c685"
...
def parse_dataset(
    ...
    class_list = os.listdir(dataset_root_path + "original_files/" + "Collada models")
    class_list.remove("maps")
    ...
    for image_path in image_path_list:
        ...
        if problem_value != 0:
            ...
            class_from_path_list = class_from_path.split(" ")
