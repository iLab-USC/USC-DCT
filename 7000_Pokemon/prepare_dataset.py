...
# 3 only 6832 images not 7000 (dataset name is 7000 pokemon)
# 4 some images (only 4) have image like extensions (e.g. jpeg.~c200, png.njsvk) that was not processed

#
# 1. constants
#

DATASET_URL_1 = "https://www.kaggle.com/datasets/lantian773030/pokemonclassification/download?datasetVersionNumber=1"
DATASET_FILE_1 = "archive.zip"
DATASET_SUM_1 = "6798da4770ba1184f977fa0874ef2740"
...
def parse_dataset(
    ...
    # create class list
    class_list = os.listdir(dataset_root_path + "original_files/" + "PokemonData")
