...
DATASET_SUM_1 = "da7482069002aa390b41519892c210c7"
...
def parse_dataset(
    ...
    files_list = get_all_files_in_directory(
        dataset_root_path + "original_files/" + "PlantDoc-Dataset-master/",
        dataset_root_path,
    )
    ...
    class_list = os.listdir(
        dataset_root_path + "original_files/" + "PlantDoc-Dataset-master/" + "train/"
    )
    ...
    for image_path in image_path_list:
        ...
        # set the set_value (train or val or test)
