...
#
# The folder ethiopia_Images is a duplicate.

#
# 1. constants
#

DATASET_URL_1 = "https://www.kaggle.com/datasets/sandeshbhat/satellite-images-to-predict-povertyafrica"
DATASET_FILE_1 = "archive.zip"
DATASET_SUM_1 = "85fe68393807cc7161d77ad4460e1615"
...
def parse_dataset(
    ...
    class_list = [i.replace("_archive", "") for i in class_list]
    ...
    for image_path in image_path_list:
        ...
        if "ethiopia_Images" in image_path:
            problem_value = 3
        ...
        if problem_value != 0:
            ...
            class_from_path = image_path.split("/")[-3].replace("_archive", "")
