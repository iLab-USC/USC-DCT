...
DATASET_SUM_1 = "2471323e565ab4faa7f6b92d6662897b"
...
def parse_dataset(
    ...
    lables_csv = pd.read_csv(f"{dataset_root_path}/original_files/Training_set.csv")
    class_list = set([i[0] for i in lables_csv[["label"]].values])
    ...
    for image_path in image_path_list:
        ...
        if problem_value != 0:
            ...
            label = lables_csv["label"][lables_csv["filename"] == file_name].values[0]
            assert label in class_dict
            class_int = class_dict[label]
