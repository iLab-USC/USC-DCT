...
DATASET_URL_1 = "https://www.kaggle.com/datasets/shiekhburhan/face-mask-dataset/download?datasetVersionNumber=1"
DATASET_FILE_1 = "archive.zip"
DATASET_SUM_1 = "4fbaa2b83665fff17fe410591bc8b6f3"
...
def parse_dataset(
    ...
    class_list = os.listdir(dataset_root_path + "original_files/" + "FMD_DATASET")
    ...
    for image_path in image_path_list:
        ...
        # without problem
            ...
            class_from_path = image_path.split("/")[-3]
