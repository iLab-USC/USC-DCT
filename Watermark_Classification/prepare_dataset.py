...
DATASET_SUM_1 = "8daae9cbc44460e833c3238b5f93da6e"
...
def parse_dataset(
    ...
    class_list = os.listdir(
        dataset_root_path + "original_files/" + "wm-nowm/" + "train"
    )
    ...
    for image_path in image_path_list:
        ...
        # this makes sure not to catch any train images with the word valid in them
        if "wm-nowm/valid" in image_path:
            set_value = 1
