...
#
# 1) 5 test images given with no label
...
DATASET_URL_1 = (
    "https://www.kaggle.com/datasets/bhav09/dragon-ball-super-saiyan-dataset"
)
DATASET_FILE_1 = "archive.zip"
DATASET_SUM_1 = "042ef83fc8778ca500512d5e75a4e94e"
...
def parse_dataset(
    ...
    class_list = [d for d in directories if d != "test_images"]
    ...
    for image_path in image_path_list:
        ...
        # set split to test if image is in test images folder, no labels though
