...
#
# 1) duplicate folder structure found
...
DATASET_URL_1 = "https://www.kaggle.com/datasets/clorichel/boat-types-recognition/download?datasetVersionNumber=2"
DATASET_FILE_1 = "archive.zip"
DATASET_SUM_1 = "0fffcfc583cb4b63298ae549b16a16b5"
...
def parse_dataset(
    ...
    # create a class dict
    class_list = os.listdir(dataset_root_path + "original_files/" + "boats")
