...
DATASET_URL_1 = "https://www.kaggle.com/datasets/shubhamgoel27/dermnet/download?datasetVersionNumber=1"
DATASET_FILE_1 = "archive.zip"
DATASET_SUM_1 = "11b6e77e0dc360a2dda34909056992ef"
...
def parse_dataset(
    ...
    class_list = os.listdir(dataset_root_path + "original_files/" + "train")
