...
DATASET_URL_1 = "https://madm.dfki.de/files/sentinel/EuroSAT.zip"
DATASET_FILE_1 = "EuroSAT.zip"
DATASET_SUM_1 = "c8fa014336c82ac7804f0398fcb19387"
...
def parse_dataset(
    ...
    # create class list
    class_list = os.listdir(dataset_root_path + "original_files/" + "2750")
