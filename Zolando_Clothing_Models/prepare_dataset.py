...
DATASET_URL_1 = "https://www.kaggle.com/datasets/dqmonn/zalando-store-crawl/download?datasetVersionNumber=1"
DATASET_FILE_1 = "archive.zip"
DATASET_SUM_1 = "4414dffcee2d409a5addeb23d7a95e9e"
...
def parse_dataset(
    ...
    # create a class dict
    class_list = os.listdir(dataset_root_path + "original_files/" + "zalando/zalando")
    ...
    for image_path in image_path_list:
        ...
        if "zalando/zalando" in image_path:
            problem_value = 3
