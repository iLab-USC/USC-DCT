...
DATASET_SUM_1 = "056ec7e5da0a7e764685431778f0d6bd"
...
def parse_dataset(
    ...
    # get unique class list from image names
    temp_list = []
    for i in image_path_list:
        t1 = i.split("/")[-1]
        t2 = "_".join(t1.split(".")[-2].split("_")[:-1])
        temp_list.append(t2)
    ...
    for image_path in image_path_list:
        ...
        if problem_value != 0:
            ...
            class_from_path = "_".join(
                image_path.split("/")[-1].split(".")[-2].split("_")[:-1]
            )
