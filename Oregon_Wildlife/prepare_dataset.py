...
DATASET_URL_1 = "https://www.kaggle.com/datasets/virtualdvid/oregon-wildlife"
DATASET_FILE_1 = "archive.zip"
DATASET_SUM_1 = "4e2991e081f16408381c7b6e5a138cec"
...
def parse_dataset(
    ...
    class_list = os.listdir(
        dataset_root_path + "original_files/" + "oregon_wildlife/oregon_wildlife"
    )
    ...
    for i, img_name in enumerate(image_path_list):  # for each image path
        ...
        if problem_value != 0:
            ...
            img_label = class_dict[img_name.split("/")[3]]
