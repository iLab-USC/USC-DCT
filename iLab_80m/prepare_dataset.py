...
#
# The class names were provided by the folder structure. No text files are provided.
...
DATASET_SUM_1 = "3e298dc47e48b58b3f5c644b0c8afcbc"
...
def parse_dataset(
    ...
    directories = get_unique_directories_from_files_list(image_path_list, 1)

    # update class_dict with class indices
    for i, class_name in enumerate(sorted(directories)):
