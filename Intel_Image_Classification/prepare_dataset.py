...
DATASET_URL_1 = "https://www.kaggle.com/datasets/puneet6060/intel-image-classification"
DATASET_FILE_1 = "archive.zip"
DATASET_SUM_1 = "7ca81e130042cf96ee43c0802da46daf"
...
def parse_dataset(
    ...
    class_list = os.listdir(
        dataset_root_path + "original_files/" + "seg_train/seg_train"
    )
    ...
    for image_path in image_path_list:
        ...
        if "seg_pred/seg_pred" in image_path:
            problem_value = 4

        if "seg_test/seg_test" in image_path:
            set_value = 2
